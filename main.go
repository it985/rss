...
var (
	...
	relevantDuration = 15 * 365 * 24 * time.Hour
    ...
    <div class="row my-card justify-content-center">
        <div class="col-lg-0 card">
            <style type="text/css">
                ...
                #flip-box-1 div:first-child {animation: show 20s linear infinite}
...
0px}
            ...
            <div class="card card-site-info">
                <div id="container-box-1">
                    <div id="flip-box-1">
                        <div class="flip-box-1-1"><i class="fa fa-gitlab" aria-hidden="true"></i> RSS feed for you</div>
                        <div class="flip-box-1-2"><i class="fa fa-heart" aria-hidden="true"></i> 我们很年轻，但我们有信念、有梦想</div>
                        <div class="flip-box-1-3"><i class="fa fa-gratipay" aria-hidden="true"></i> 支持你的总会支持你，不支持的做再多也徒劳</div>
                        <div class="flip-box-1-4"><i class="fa fa-drupal" aria-hidden="true"></i> 做这个世界的逆行者，先人一步看未来</div>
                        <div class="flip-box-1-5"><i class="fa fa-gitlab" aria-hidden="true"></i> 只要你用心留意，世界将无比精彩</div>
                        <div class="flip-box-1-6"><i class="fa fa-moon-o" aria-hidden="true"></i> 以下是信息聚合，精选各大站内容</div>
                        <div class="flip-box-1-1">感谢原创者，感谢分享者，感谢值得尊重的每一位</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-site-info">
                <div class="m-3">
                    <marquee scrollamount="5" behavior="right">
                        <div id="blink">
                            <a href="https://morss.it/:proxy:items=%7C%7C*[class=card]%7C%7Col%7Cli/https://rcy1314.github.io/news/" target="_blank">📢：RSS feed for you 🔛</a> RSS 聚合阅读页 🎁
                        </div>
                        <script>
